...
QStringList ThemeManager::configKeys() const
{
    return {
        ...
        QStringLiteral("timezone_show_day"), QStringLiteral("timezone_day_format"),
        QStringLiteral("timezone_uppercase_day"),
        QStringLiteral("timezone_show_date"), QStringLiteral("timezone_date_format"),
        QStringLiteral("timezone_uppercase_date"),
        QStringLiteral("timezone_show_time"), QStringLiteral("timezone_locale"),
